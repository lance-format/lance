...
//! Every action the specification defines is implemented here, so the two
//! vocabularies now coincide -- an action a newer Lance writes is rejected on
//! load rather than skipped.
//!
