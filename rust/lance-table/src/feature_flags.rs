...
/// "keyed columns plus carried columns", with the carried ones forming a subset
/// of `fields` that holds no repeated id. A reader without this bit still selects
...
/// so it cannot open a table and apply the legacy subset contract to
